...
public partial class MainController : Node
{
	...
	public void Connected()
	{
		...
		// Auto-connect webhook if URL is saved
		if (!string.IsNullOrWhiteSpace(WebhookManager.Config?.WebhookUrl) && !WebhookManager.IsConnected)
		{
			_ = WebhookManager.ConnectAsync(); // fire-and-forget async connection
		}
	...
	public static void AddDeath(string source)
	{
		...
		// Send ANSI death message to webhook
		/**_ = WebhookHandler.ProcessMessageAsync("deathlink", source, "");*/
		WebhookHandler.SendDeath(source);
	}
